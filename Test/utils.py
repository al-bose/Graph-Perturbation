def load_data(name, train):
    if name == 'syn':
        ...
        from data import ALKANEData
        return ALKANEData(train)
    elif name == 'nasa':
        from data import NASAData
        return NASAData(train)
    elif name == 'nci109':
        ...
        from data import WebHardData
        return WebHardData(train)
    elif name == 'linux_imdb':
        from data import LINUX_IMDBMultiData
        return LINUX_IMDBMultiData(train)
    elif name == 'reddit5k':
        ...
        from data import MUTAGData
        return MUTAGData(train)
    elif name == 'collab':
        from data import COLLABData
        return COLLABData(train)
    elif name == 'dd':
        from data import DDData
        return DDData(train)
    elif name == 'nci1':
        from data import NCI1Data
        return NCI1Data(train)
    else:
