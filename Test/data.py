...
class ALKANEData(Data):
    def __init__(self, train):
        self.train = train
        super(ALKANEData, self).__init__(get_train_str(train))

    def init(self):
        self.graphs = get_proc_graphs('ALKANE', self.train)


class NASAData(Data):
    def __init__(self, train):
        self.train = train
        super(NASAData, self).__init__(get_train_str(train))

    def init(self):
        self.graphs = get_proc_graphs('NASA', self.train)
...
class WebHardData(Data):
    def __init__(self, train):
        self.train = train
        super(WebHardData, self).__init__(get_train_str(train))

    def init(self):
        self.graphs = get_proc_graphs('WEBHARD', self.train)
        self.graphs, self.glabels = add_glabel_to_each_graph(self.graphs, '', True)
        assert (self.glabels is None)  # fake graph labels


class LINUX_IMDBMultiData(Data):  # train on linux, test on imdb
    def __init__(self, train):
        self.train = train
    ...
    def init(self):
        if self.train:
            self.graphs = get_proc_graphs('LINUX', self.train)
        else:
            self.graphs = get_proc_graphs('IMDBMulti', self.train)
...
class MUTAGData(Data):
    def __init__(self, train):
        self.train = train
        super(MUTAGData, self).__init__(get_train_str(train))
...
class COLLABData(Data):
    def __init__(self, train):
        self.train = train
        super(COLLABData, self).__init__(get_train_str(train))
...
class DDData(Data):
    def __init__(self, train):
        self.train = train
        super(DDData, self).__init__(get_train_str(train))
...
class NCI1Data(Data):
    def __init__(self, train):
        self.train = train
        super(NCI1Data, self).__init__(get_train_str(train))
